...
const DEFAULT_SITE = {
  ...
  info_horario: 'Festa: 17h · Cerimônia: 18h (pontual)',
...
const DEFAULT_ROTEIRO = {
  itens: [
    { horario: '17:00', titulo: 'Chegada e Welcome Drink', descricao: 'Os convidados chegam e são recebidos com drinks de boas-vindas na varanda.', icone: '🥂', destaque: false },
