...
const DEFAULT_CARDAPIO = {
  heroTitle: 'Cardapio Digital da Festa',
  heroSubtitle: 'Uma selecao pensada com carinho para tornar essa noite ainda mais inesquecivel.',
  secoes: [
    {
      id: 'entradas',
      title: 'Entradas',
      ...
      items: [
        {
          name: 'Bruschetta de Tomate Confit e Manjericao',
          description: 'Pao artesanal tostado, tomate confit, azeite extra virgem e folhas frescas.'
        },
        {
          name: 'Mini Quiche de Alho-Poro',
          description: 'Massa amanteigada com recheio cremoso de alho-poro e queijo suave.'
        },
        {
          name: 'Ceviche Tropical',
          description: 'Peixe fresco marinado com limao, cebola roxa, manga e coentro.'
        }
      ]
    },
    {
      ...
      items: [
        {
          ...
          description: 'Servido com risoto de parmesao e crocante de alho-poro.'
        },
        {
          name: 'Salmao Grelhado com Ervas',
          description: 'Acompanhado de pure de mandioquinha e legumes tostados.'
        },
        {
          name: 'Ravioli de Cogumelos',
          description: 'Massa fresca ao molho de manteiga de salvia e nozes torradas.'
        }
      ]
    },
    {
      id: 'sobremesas',
      title: 'Sobremesas',
      subtitle: 'Doces memorias para fechar o jantar',
      items: [
        {
        ...
        },
        {
          ...
          description: 'Coberta com calda de frutas vermelhas e crocante de amendoas.'
        },
        {
          name: 'Mini Tartelette de Limao Siciliano',
          description: 'Base crocante, creme citrico e merengue macaricado.'
        }
      ]
    },
    {
      ...
      subtitle: 'Drinks autorais e classicos para brindar',
      items: [
        {
          name: 'French 75',
          description: 'Gin, suco de limao, xarope de acucar e espumante brut.'
        },
        {
          name: 'Moscow Mule da Casa',
          description: 'Vodka, espuma de gengibre, limao e toque de hortela.'
        },
        {
    ...
    {
      id: 'nao-alcoolicas',
      title: 'Bebidas Nao Alcoolicas',
      subtitle: 'Opcoes refrescantes para todos os convidados',
      items: [
        {
          name: 'Aguas Aromatizadas',
          description: 'Sabores de limao siciliano com alecrim e frutas vermelhas com hortela.'
        },
        {
          name: 'Mocktail de Maracuja',
          description: 'Polpa natural, citricos frescos e espuma leve de gengibre.'
        },
        {
          name: 'Sucos Naturais',
          description: 'Laranja, abacaxi com hortela e melancia preparados na hora.'
        }
      ]
    }
  ]
