// Posições iniciais baseadas no layout real da foto do salão.
// cx e cy são percentuais (0-100) sobre largura e altura da imagem.
// r: raio do círculo em unidades viewBox (viewBox = "0 0 100 130")
// Ajuste fino feito pelo admin através do painel de calibração.

export const MESA_POSITIONS_DEFAULT = [
  // --- Linha superior (próxima ao buffet e DJ) ---
...
export const MAPA_CROP_VERSION = 2;
...
// Aspect ratio real da imagem do salão (largura / altura)
// Ajuste se a imagem tiver dimensões diferentes
export const MAPA_ASPECT_RATIO = 0.597;
